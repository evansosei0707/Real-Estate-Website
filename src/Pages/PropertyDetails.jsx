  ...
  return (
     <section>
      <div className="container mx-auto min-h-[800px] mb-14">
        <div className='flex flex-col mx-auto lg:flex-row lg:items-center lg:justify-between ' >
        ...
        <div className='flex flex-col items-start gap-x-6 gap-y-2 lg:flex-row'>
          <div className='max-w-[768px]'>
              <div className='mb-8'>
                <img src={house.imageLg} alt='' />
              </div>
            
            <div className='flex items-center gap-x-6 text-violet-700 mb-6'>
            ...
            <div className='text-left max-w-[740px]'>{house.description}</div>
          </div>
          <div className='flex-1 bg-white w-full mb-9 border border-gray-300 rounded-lg px-6 py-8  '>
            ...
            <form className='flex flex-col gap-y-4'>
              ...
              <textarea className='border border-gray-300 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400' placeholder='Message' defaultValue='Hello, I am interest in [Modern apaartment]'></textarea>
